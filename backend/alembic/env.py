...
This file is executed by Alembic to run migrations.
It reads the database URL from the application settings
(not from alembic.ini) to stay DRY.
"""
...
from app.modules.promotions.models import (  # noqa: F401
    Promocion,
    PromocionProducto,
)
